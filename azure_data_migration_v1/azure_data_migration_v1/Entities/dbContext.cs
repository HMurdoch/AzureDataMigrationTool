...
public partial class dbContext : DbContext
{
    ...
    public virtual DbSet<MimBusiness001> MimBusiness001s { get; set; }

    public virtual DbSet<MimDocuments001> MimDocuments001s { get; set; }

    public virtual DbSet<MimDocumentsGapr001> MimDocumentsGapr001s { get; set; }

    public virtual DbSet<MimDocumentsPages001> MimDocumentsPages001s { get; set; }

    public virtual DbSet<MimDocumentsPagesGapr001> MimDocumentsPagesGapr001s { get; set; }

    public virtual DbSet<MimPerson001> MimPerson001s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<MimBusiness001>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mim_business_001", tb =>
                {
                    tb.HasTrigger("bat_mim_business_001_delt");
                    tb.HasTrigger("bat_mim_business_001_inst");
                    tb.HasTrigger("bat_mim_business_001_updt");
                });

            entity.HasIndex(e => e.MimBusinessId, "mim_business_id_ind")
                .IsUnique()
                .HasFillFactor(100);

            entity.HasIndex(e => e.MimBusinessLegalName, "mim_business_legal_name_ind").HasFillFactor(100);

            entity.HasIndex(e => e.MimBusinessLegalRegistrationNo, "mim_business_legal_registration_no_ind").HasFillFactor(100);

            entity.HasIndex(e => e.MimBusinessTradingName, "mim_business_trading_name_ind").HasFillFactor(100);

            entity.HasIndex(e => e.MimControlId, "mim_control_id_ind")
                .IsUnique()
                .IsClustered()
                .HasFillFactor(100);
            ...
            entity.Property(e => e.MimBusinessId)
                .HasDefaultValueSql("(newsequentialid())")
                .HasColumnName("mim_business_id");
        ...
        modelBuilder.Entity<MimDocuments001>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mim_documents_001", tb =>
                {
                    tb.HasTrigger("bat_mim_documents_001_delt");
                    tb.HasTrigger("bat_mim_documents_001_inst");
                    tb.HasTrigger("bat_mim_documents_001_updt");
                });

            entity.HasIndex(e => new { e.MimControlId, e.CcgDocTypeScode, e.CcgTenantScode }, "mim_control_id_ind");

            entity.HasIndex(e => e.MimDocumentsId, "mim_documents_id_ind")
                .IsUnique()
                .HasFillFactor(100);
            ...
            entity.Property(e => e.MimDocumentsId)
                .HasDefaultValueSql("(newsequentialid())")
                .HasColumnName("mim_documents_id");
        ...
        modelBuilder.Entity<MimDocumentsGapr001>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mim_documents_gapr_001", tb =>
                {
                    tb.HasTrigger("bat_mim_documents_gapr_001_delt");
                    tb.HasTrigger("bat_mim_documents_gapr_001_inst");
                    tb.HasTrigger("bat_mim_documents_gapr_001_updt");
                });

            entity.HasIndex(e => new { e.CcgDocTypeScode, e.MimControlId, e.CcgTenantScode }, "mim_control_id_ind")
                .IsClustered()
                .HasFillFactor(100);
        ...
        modelBuilder.Entity<MimDocumentsPages001>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mim_documents_pages_001", tb =>
                {
                    tb.HasTrigger("bat_mim_documents_pages_001_delt");
                    tb.HasTrigger("bat_mim_documents_pages_001_inst");
                    tb.HasTrigger("bat_mim_documents_pages_001_updt");
                });

            entity.HasIndex(e => e.MimDocumentsPagesId, "mim_documents_pages_id_ind")
                .IsUnique()
                .HasFillFactor(100);

            entity.HasIndex(e => new { e.MimDocumentsId, e.CcgDocTypeScode, e.MimControlId, e.MimDocumentsPagesItemNo }, "mim_documents_pages_pk_ind")
                .IsUnique()
                .IsClustered()
                .HasFillFactor(100);
            ...
            entity.Property(e => e.MimDocumentsPagesId)
                .HasDefaultValueSql("(newsequentialid())")
                .HasColumnName("mim_documents_pages_id");
        ...
        modelBuilder.Entity<MimDocumentsPagesGapr001>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mim_documents_pages_gapr_001", tb =>
                {
                    tb.HasTrigger("bat_mim_documents_pages_gapr_001_delt");
                    tb.HasTrigger("bat_mim_documents_pages_gapr_001_inst");
                    tb.HasTrigger("bat_mim_documents_pages_gapr_001_updt");
                });
        ...
        modelBuilder.Entity<MimPerson001>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mim_person_001", tb =>
                {
                    tb.HasTrigger("bat_mim_person_001_delt");
                    tb.HasTrigger("bat_mim_person_001_inst");
                    tb.HasTrigger("bat_mim_person_001_updt");
                });
            ...
            entity.HasIndex(e => e.MimPersonCdate, "mim_person_cdate_ind").HasFillFactor(100);

            entity.HasIndex(e => e.MimPersonId, "mim_person_id_ind")
                .IsUnique()
                .HasFillFactor(100);

            entity.HasIndex(e => e.MimPersonNameFirst, "mim_person_name_first_ind").HasFillFactor(100);

            entity.HasIndex(e => e.MimPersonNameSurname, "mim_person_name_surname_ind").HasFillFactor(100);
            ...
            entity.Property(e => e.MimPersonId)
                .HasDefaultValueSql("(newsequentialid())")
                .HasColumnName("mim_person_id");
